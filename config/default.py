...
**معايير AAOIFI المسترجعة تلقائيًا (للمرجعية):**
{aaoifi_context}
...
4.  معايير AAOIFI ذات الصلة المسترجعة من مستودع المعايير.
...
3.  معايير AAOIFI ذات الصلة للمرجعية في التقييم الشرعي.
...
**معايير AAOIFI المسترجعة تلقائيًا (للمرجعية الشرعية):**
{aaoifi_context}

**تعليمات الاستخدام:**
- عند إعادة بناء العقد، تأكد أن جميع التعديلات تتوافق مع معايير AAOIFI المذكورة أعلاه
- حافظ على الشروط الإسلامية الصحيحة في الصيغة النهائية
