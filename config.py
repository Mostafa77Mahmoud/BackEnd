...
# For local development, these are loaded from the .env file by api_server.py.
...
# Flask Secret Key
FLASK_SECRET_KEY = os.getenv("FLASK_SECRET_KEY", "default_fallback_secret_key")


# --- Application Configuration ---
# These values are less sensitive and can have defaults.
...
# Model Configuration
MODEL_NAME = os.getenv("MODEL_NAME", "gemini-2.0-flash-thinking-exp-01-21")
